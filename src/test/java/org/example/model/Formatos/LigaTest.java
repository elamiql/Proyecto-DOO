...
class LigaTest {
    ...
    void setUp() {
        ...
        plantillaEstadisticas = new EstadisticasFutbol(); // Constructor sin parámetros
    }
    ...
    void ligaDobleVuelta_dosParticipantes_generaDosEnfrentamientos() {
        ...
        Liga<Equipo, ResultadoFutbol, EstadisticasFutbol> liga = new Liga<>(equipos, true, plantillaEstadisticas);
    ...
    void ligaVueltaSimple_tresParticipantes_generaTresEnfrentamientos() {
        ...
        // Especificar explícitamente los tipos genéricos
        Liga<Equipo, ResultadoFutbol, EstadisticasFutbol> liga = new Liga<>(equipos, false, plantillaEstadisticas);
        liga.generarEnfrentamientos();
