...
class EstadisticasTenisTest {
    ...
    void testRegistrarVictoriaConTiebreak() {
        ResultadoTenis resultado = new ResultadoTenis(j1, j2, 3, j1);
        ...
        assertEquals(j1, resultado.getGanador());
    }

    @Test
    void testRegistrarDerrotaSinTiebreak() {
        ResultadoTenis resultado = new ResultadoTenis(j1, j2, 3, j2);
        ...
        assertEquals(0, estadisticas.getPartidosPerdidosEnTiebreak());
        assertEquals(j2, resultado.getGanador());
    }

    @Test
    void testPorcentajesYPromedios() {
        ResultadoTenis resultado1 = new ResultadoTenis(j1, j2, 3, j1);
        resultado1.agregarSet(0, 6, 4); // gana set normal
        resultado1.agregarSet(1, 7, 6); // gana set tiebreak

        ResultadoTenis resultado2 = new ResultadoTenis(j1, j2, 3, j2);
