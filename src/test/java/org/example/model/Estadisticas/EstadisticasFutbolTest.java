...
class EstadisticasFutbolTest {
    ...
    void testRegistrarVictoriaLocal() {
        ...
        ResultadoFutbol resultado = new ResultadoFutbol(equipo, visitante, 3, 1, equipo);
    ...
    void testRegistrarEmpateVisitante() {
        ...
        ResultadoFutbol resultado = new ResultadoFutbol(local, equipo, 2, 2, null);
    ...
    void testRegistrarDerrotaLocal() {
        Equipo visitante = new Equipo("Equipo B", "2", new ArrayList<>());
        ResultadoFutbol resultado = new ResultadoFutbol(equipo, visitante, 0, 2, visitante);
    ...
    void testToTablaString() {
        Equipo visitante = new Equipo("Equipo B", "2", new ArrayList<>());
        ResultadoFutbol resultado = new ResultadoFutbol(equipo, visitante, 1, 0, equipo);
    ...
    void testRegistrarResultadoNoValidoLanzaExcepcion() {
        Equipo visitante = new Equipo("Equipo B", "2", new ArrayList<>());
        ResultadoFutbol resultado = new ResultadoFutbol(equipo, visitante, -1, 2, null); // invalido porque <0
