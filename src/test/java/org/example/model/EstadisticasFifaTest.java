...
import org.example.model.Estadisticas.EstadisticasFifa;
...
class EstadisticasFifaTest {
    ...
    void testRegistrarVictoriaLocal() {
        ...
        ResultadoFifa resultado = new ResultadoFifa(equipo, visitante, 3, 1);
    ...
    void testRegistrarEmpateVisitante() {
        ...
        ResultadoFifa resultado = new ResultadoFifa(local, equipo, 2, 2);
    ...
    void testRegistrarDerrotaLocal() {
        Equipo visitante = new Equipo("Equipo B", "2", new ArrayList<>());
        ResultadoFifa resultado = new ResultadoFifa(equipo, visitante, 0, 2);
    ...
    void testToTablaString() {
        Equipo visitante = new Equipo("Equipo B", "2", new ArrayList<>());
        ResultadoFifa resultado = new ResultadoFifa(equipo, visitante, 1, 0);
